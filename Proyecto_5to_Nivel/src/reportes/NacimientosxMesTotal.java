...
@WebServlet("/NacimientosxMesTotal")
public class NacimientosxMesTotal extends HttpServlet {
   ...
   protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			String ruta = "file:" + this.getServletContext().getRealPath("reportes/NacimientosxMesTotal.prpt");
