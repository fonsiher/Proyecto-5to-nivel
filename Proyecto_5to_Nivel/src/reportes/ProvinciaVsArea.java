...
@WebServlet("/ProvinciaVsArea")
public class ProvinciaVsArea extends HttpServlet {
   ...
   protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			String ruta = "file:" + this.getServletContext().getRealPath("reportes/ProvinciaVsArea.prpt");
