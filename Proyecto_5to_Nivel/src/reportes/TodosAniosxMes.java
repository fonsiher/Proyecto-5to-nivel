...
@WebServlet("/TodosAniosxMes")
public class TodosAniosxMes extends HttpServlet {
   ...
   protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			String ruta = "file:" + this.getServletContext().getRealPath("reportes/TodosAniosxMes.prpt");
