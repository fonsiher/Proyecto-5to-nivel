...
@WebServlet("/TodosEtniaAnio")
public class TodosEtniaAnio extends HttpServlet {
   ...
   protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			String ruta = "file:" + this.getServletContext().getRealPath("reportes/TodosEtniaAnio.prpt");
