...
@WebServlet("/TodosProvinciaAnio")
public class TodosProvinciaAnio extends HttpServlet {
   ...
   protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			String ruta = "file:" + this.getServletContext().getRealPath("reportes/TodosProvinciaAnio.prpt");
